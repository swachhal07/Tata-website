...
export const products = [
  ...
  },
  {
    ...
    specs: [
      ...
      { label: 'Engine power', value: '112 HP' },
      { label: 'Bucket capacity', value: '0.66 m³' },
      { label: 'Max digging depth', value: '5.8 m' },
      { label: 'Fuel tank', value: '240 L' },
      { label: 'Track class', value: 'Standard' },
    ],
  ...
  },
  {
    ...
    specs: [
      ...
      { label: 'Engine power', value: '68 HP' },
      { label: 'Bucket capacity', value: '0.34 m³' },
      { label: 'Max digging depth', value: '4.6 m' },
